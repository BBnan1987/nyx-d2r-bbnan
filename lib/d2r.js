...
module.exports = {
  ...
  getRuntimeMode: binding.getRuntimeMode,
  setRuntimeMode: binding.setRuntimeMode,
  isActiveMutationEnabled: binding.isActiveMutationEnabled,
};
